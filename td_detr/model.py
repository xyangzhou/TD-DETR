...
from td_detr.span_utils import generalized_temporal_iou, span_cxw_to_xx

from td_detr.matcher import build_matcher
from td_detr.transformer import build_transformer
from td_detr.position_encoding import build_position_encoding
from td_detr.misc import accuracy
import numpy as np
...
class TDDETR(nn.Module):
    ...
    def __init__(self, transformer, position_embed, txt_position_embed, txt_dim, vid_dim,
        ...
        Parameters:
            ...
            num_queries: number of object queries, ie detection slot. This is the maximal number of objects
                         TD-DETR can detect in a single video.
        ...
        self.video_embed = nn.Embedding(1, hidden_dim)
        relu_args = [True] * 3
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_aud=None, src_aud_mask=None):
        ...
        flow_sof = self.video_embed.weight.unsqueeze(0).repeat(src_vid.shape[0], 1, 1)
        hs, reference, memory, memory_global = self.transformer(src, ~mask, self.query_embed.weight, pos, video_length=video_length, sof_token=flow_sof)
        ...
        _, _, memory_neg, memory_global_neg = self.transformer(src_neg, ~mask_neg, self.query_embed.weight, pos_neg, video_length=video_length, sof_token=flow_sof)
