...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl", 'tvsum', 'charades', 'charades_cg', 'tacos', 'ego4d'])
        ...
        # training config
        parser.add_argument("--sample_strategy", type=str, default='sim', help="sample strategy")
        parser.add_argument("--lr", type=float, default=1e-4, help="learning rate")
        parser.add_argument("--lr_drop", type=int, default=400, help="drop learning rate to lr_gamma every lr_drop epochs")
        ...
        parser.add_argument("--sim_matrix_path", type=str, default="./similarity_matrix")
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['td_detr/model.py', 'td_detr/transformer.py']
